<template>
  <div class="page">
    <router-view />
    <img @touchstart="down" @touchmove="move" @touchend="end" @click="goHome" v-if="showBack" id="back-home" src="../../assets/back_home.png">
  </div>
</template>
<script>
export default {
	...
	methods: {
		...
		//返回首页
		goHome() {
			if (this.$route.name != 'StaffSelectTo') {
				this.$router.push({
					path: 'StaffSelectTo',
					query: {
